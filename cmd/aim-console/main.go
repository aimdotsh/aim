...
func main() {
	...
	backupRoot := env("AIM_BACKUP_ROOT", filepath.Join(dataDir, "backups"))
	for _, path := range []string{filepath.Join(dataDir, "uploads"), filepath.Join(dataDir, "media"), backupRoot} {
